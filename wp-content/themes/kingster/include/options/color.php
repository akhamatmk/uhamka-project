			...
			'course-color' => array(
				...
				'options' => array(
					...
					'course-list-title-color' => array(
						'title' => esc_html__('Course List Title Color', 'kingster'),
						'type' => 'colorpicker',
						'default' => '#6b6b6b',
						'selector' => '.gdlr-core-course-item.gdlr-core-course-style-list .gdlr-core-course-item-title{ color: #gdlr#; }'
					),
					'course-list-title-hover-color' => array(
						'title' => esc_html__('Course List Title Hover Color', 'kingster'),
						'type' => 'colorpicker',
						'default' => '#6b6b6b',
						'selector' => '.gdlr-core-course-item.gdlr-core-course-style-list .gdlr-core-course-item-title:hover{ color: #gdlr#; }'
					),
